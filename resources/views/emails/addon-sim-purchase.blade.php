...
<head>
  ...
  <title>Add-on SIMs Activated – Callytics</title>
</head>
...
@php
  ...
  $amount        = number_format((float) $addon->amount, 2);
  $pricePerSim   = number_format((float) $addon->price_per_sim, 2);
  $simQty        = (int) $addon->sim_quantity;
            ...
            <table width="100%" cellpadding="0" cellspacing="0">
              <tr>
                <td>
                  ...
                  <p style="margin:4px 0 0;font-size:12px;color:#94a3b8;">Add-on SIM Purchase Confirmation</p>
                </td>
                <td align="right">
        ...
        <tr>
          <td style="background:#ffffff;padding:36px 40px;">
            ...
            <h1 style="font-size:22px;font-weight:800;color:#10233f;text-align:center;margin:0 0 10px;letter-spacing:-0.02em;">
              Add-on SIMs Activated!
            </h1>
            <p style="font-size:15px;color:#6b7280;text-align:center;margin:0 0 28px;line-height:1.6;">
              Hi <strong style="color:#10233f;">{{ $customerName }}</strong>, your add-on SIM purchase was successful.<br>
              <strong style="color:#f97316;">{{ $simQty }} additional SIM(s)</strong> have been added to your subscription.
            </p>
            ...
            <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:24px;">
              <tr>
                <td style="padding-bottom:10px;">
                  <p style="margin:0 0 10px;font-size:11px;font-weight:700;text-transform:uppercase;letter-spacing:0.1em;color:#94a3b8;">Add-on Details</p>
                  <table width="100%" cellpadding="0" cellspacing="0" style="border:1px solid #e2e8f0;border-radius:10px;overflow:hidden;">
                    ...
                    <tr style="border-top:1px solid #e2e8f0;">
                      <td style="padding:12px 16px;font-size:12px;color:#6b7280;font-weight:600;">Add-on SIMs</td>
                    ...
                    <tr style="background:#f8fafc;border-top:1px solid #e2e8f0;">
                      <td style="padding:12px 16px;font-size:12px;color:#6b7280;font-weight:600;">Remaining Days</td>
                      <td style="padding:12px 16px;font-size:12px;color:#10233f;font-weight:700;">{{ $remainingDays }} days (prorated)</td>
                    </tr>
                    <tr style="border-top:1px solid #e2e8f0;">
                      <td style="padding:12px 16px;font-size:12px;color:#6b7280;font-weight:600;">Active Until</td>
            ...
            <div style="background:linear-gradient(135deg,#fff7ed,#ffedd5);border:1.5px solid #fed7aa;border-radius:12px;padding:20px 24px;text-align:center;margin-bottom:28px;">
              <p style="margin:0;font-size:12px;color:#9a3412;font-weight:600;text-transform:uppercase;letter-spacing:0.08em;">Total Amount Paid (Prorated)</p>
            ...
            <div style="background:#f8fafc;border:1px solid #e2e8f0;border-radius:10px;padding:14px 18px;margin-bottom:8px;">
              <p style="margin:0;font-size:12px;color:#374151;">
                <strong>&#128196; Invoice attached:</strong> Your PDF invoice <strong>{{ strtolower($invoiceNumber) }}.pdf</strong> is attached to this email.
              </p>
            </div>
