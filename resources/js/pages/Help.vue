  ...
  <div>
    ...
    <section id="help-hero" class="relative text-gray-900 overflow-hidden hero-section" aria-labelledby="help-title">
      ...
      <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 text-center">
        <h1 id="help-title" class="text-4xl md:text-5xl font-bold mb-6">
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
          ...
          <div class="fade-up" style="animation-delay: 0.1s;">
            ...
            <div class="text-sm text-gray-600 font-semibold">Email Support</div>
          </div>
          <div class="fade-up" style="animation-delay: 0.2s;">
            <div class="flex items-center justify-center mb-2">
              ...
              <span class="text-2xl font-bold text-orange-600">Secure</span>
            </div>
