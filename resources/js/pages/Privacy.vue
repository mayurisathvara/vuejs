        ...
        <div class="prose prose-lg max-w-none">
          <div class="p-6 mb-8" style="background-color: #fff5e6; border-left: 4px solid #ff6b00;">
            <p class="text-gray-700">
              At Callytics, we take your privacy seriously. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our service.
            </p>
          </div>
          ...
          <div class="space-y-8">
            <section>
              ...
              <div class="text-gray-700 space-y-4">
                <h3 class="text-xl font-semibold text-gray-900 mt-4">Personal Information</h3>
                <p>
                ...
                <h3 class="text-xl font-semibold text-gray-900 mt-4">Call Data</h3>
                <p>
                  When you use our call tracking service, we collect:
                </p>
                <ul class="list-disc pl-6 space-y-2">
                  <li>Phone numbers (caller and recipient)</li>
                  <li>Call duration, time, and date</li>
                  <li>Call recordings (when enabled)</li>
                  <li>Call transcriptions and analytics data</li>
                  <li>Marketing source and campaign information</li>
                </ul>

                <h3 class="text-xl font-semibold text-gray-900 mt-4">Automatically Collected Information</h3>
                <ul class="list-disc pl-6 space-y-2">
            ...
            <section>
              ...
              <div class="text-gray-700">
                ...
                <p class="mt-4">
                  To exercise these rights, please contact us at privacy@callytics.com
                </p>
              </div>
            </section>
            ...
            <section>
              ...
              <div class="text-gray-700">
                <p>
                  We retain your information for as long as necessary to provide our services and comply with legal obligations. Call recordings are typically retained for 90 days unless you specify otherwise. Account information is retained until you close your account or request deletion.
                </p>
              </div>
            </section>
