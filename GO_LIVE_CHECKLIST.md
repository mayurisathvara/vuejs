...
|------|---|---------------|---------------|------|------|
| ☐ | 1 | **API Base URL** | `http://192.168.1.7:8000/api` | `src/services/api.ts` | 9 |
| ☐ | 2 | **Privacy Policy URL** | `http://192.168.1.7:8000/privacy` | `src/constants/index.ts` | 63 |
| ☐ | 3 | **Terms & Conditions URL** | `http://192.168.1.7:8000/terms` | `src/constants/index.ts` | 64 |
...
**Item 1 — API Base URL:**  
Change `http://192.168.1.7:8000/api` to your production server URL.  
